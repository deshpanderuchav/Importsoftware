...
public class ImportTaskCellFactory implements Callback<TreeTableColumn, TreeTableCell> {

    @Override
    public TreeTableCell call(TreeTableColumn p) {

        TreeTableCell cell = new TreeTableCell<ImportTaskTableModel, Object>() {
            ...
            public void updateItem(Object item, boolean empty) {
                ...
                ImportTaskTableModel currentRecord = (ImportTaskTableModel) currentRow.getItem();
